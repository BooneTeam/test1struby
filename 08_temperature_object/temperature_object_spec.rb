...
describe Temperature do
  ...
  describe "can be constructed via factory methods" do
    ...
    it "in degrees celsius" do
      Temperature.c(50).in_celsius.should == 50
      Temperature.c(50).in_fahrenheit.should == 122
    end

    it "in degrees fahrenheit" do
      Temperature.f(50).in_fahrenheit.should == 50
      Temperature.f(50).in_celsius.should == 10
    end
